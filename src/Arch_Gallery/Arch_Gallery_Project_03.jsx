...
function Arch_Project_03({ onBackClick }) {
  ...
  const handleNextImage = (e) => {
    e.stopPropagation();
    setCurrentImageIndex((prevIndex) => (prevIndex + 1) % ArchPr03ImgData.length);
  };
  ...
  const handlePreviousImage = (e) => {
    ...
    setCurrentImageIndex(
      (prevIndex) =>
        (prevIndex - 1 + ArchPr03ImgData.length) % ArchPr03ImgData.length
    );
  };
  ...
  return (
    <div className="agp_container">
      ...
      <div className="agp_main_image_container" onClick={handleImgEnlargement}>
        <Arch_Gallery_Project_Image {...ArchPr03ImgData[currentImageIndex]} />
      </div>
      ...
      {isImgLarge && (
        <div className="enlargedImage" onClick={handleImgEnlargement}>
          <div className="enlargedImageContent">
            ...
            <img
              src={ArchPr03ImgData[currentImageIndex].image}
              alt={ArchPr03ImgData[currentImageIndex].title}
            />
